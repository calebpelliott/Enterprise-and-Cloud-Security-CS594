...
/*
 * TOD specify custom forms authentication with login page /login.xhtml, login error page /loginError.xhtml
 */
...
/*
 * TOD specify authentication and authorization using a database (see spec for guidance).
